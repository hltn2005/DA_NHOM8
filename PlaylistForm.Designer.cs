namespace TrinhPhatNhac
{
	partial class PlaylistForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.ptbFindSongs = new System.Windows.Forms.PictureBox();
			((System.ComponentModel.ISupportInitialize)(this.dgvPlayList)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.ptbFindSongs)).BeginInit();
			this.SuspendLayout();
			// 
			// btnRemoveSong
			// 
			...
			this.dgvPlayList.AlternatingRowsDefaultCellStyle = dataGridViewCellStyle1;
			...
			this.dgvPlayList.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle2;
			...
			this.ColSigerName.DefaultCellStyle = dataGridViewCellStyle4;
			...
			// ptbFindSongs
			// 
			this.ptbFindSongs.Image = global::TrinhPhatNhac.Properties.Resources.Search;
			this.ptbFindSongs.Location = new System.Drawing.Point(341, 16);
			this.ptbFindSongs.Name = "ptbFindSongs";
			this.ptbFindSongs.Size = new System.Drawing.Size(25, 22);
			this.ptbFindSongs.SizeMode = System.Windows.Forms.PictureBoxSizeMode.Zoom;
			this.ptbFindSongs.TabIndex = 18;
			this.ptbFindSongs.TabStop = false;
			this.ptbFindSongs.Click += new System.EventHandler(this.ptbFindSongs_Click);
			// 
			// PlaylistForm
			// 
			...
			this.Controls.Add(this.ptbFindSongs);
			...
			((System.ComponentModel.ISupportInitialize)(this.ptbFindSongs)).EndInit();
        ...
        private System.Windows.Forms.PictureBox ptbFindSongs;
    }
}